...
## Create Container
  ...
  Now you can run the command to create a tiff:
    ...
    python adcirc2geotiff.py --inputDIR /data/sj37392jdj28538/input --outputDIR /data/sj37392jdj28538/cogeo --inputFile maxele.63.nc --chunkSize 2
...
When running the container in Kubernetes the command line for adcirc2geotiff.py is:
    ...
    conda run -n adcirc2cog python adcirc2geotiff.py --inputDIR /xxxx/xxxxxxxxxx/input --outputDIR /xxxx/xxxxxxxxxx/cogeo --inputFile maxele.63.nc --chunkSize 2
